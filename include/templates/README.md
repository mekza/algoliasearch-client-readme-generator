...
<%= import("build_status.info") if !cmd? && !csharp? && !android? && !objc? %>
 ...
 * **<%= puts({'C#' => 'SetMaxNumberOfFacets', 'Java' => 'setMaxNumberOfFacets', 'Android' => 'setMaxNumberOfFacets'}, "maxNumberOfFacets") %>**: Limit the number of facet values returned for each facet. For example: `maxNumberOfFacets=10` will retrieve max 10 values per facet.
